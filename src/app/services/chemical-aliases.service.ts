...
export class ChemicalAliasesService {
  ...
  private hardcodedAliases: { [key: string]: string[] } = {
    ...
    'Aluminum and Diethyl Ether': ['Alluminum and Diethyl Ether'],
    'Aluminum Oxide': ['Alpha-alumina', 'Aluminia', 'Aluminum Oxide Powder'],
    'Ammonia': [],
    'Acetylene': ['Acetylene and Ammonia'],
    ...
    'Chlorine': [],
    'Chlorine Dioxide': [],
    'Chlorine Trifluoride': ['Chlorine Trifluoride and Carbon'],
    'Chloroform': ['Trichloromethane'],
    'Chloroform and Sodium Methoxide': [],
    'Chloroform-methanol': [],
    'Chlorosulfonic Acid': [],
    'Chromic Acid': [],
    'Chromium Oxide': ['Chromic Oxide'],
    'Chromium Trioxide': [],
    'Chromyl Chloride': [],
